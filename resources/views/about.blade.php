<x-app-layout>
    <div class="flex flex-col">
        ...
        <div class="flex flex-row space-x-3">
            <a href="https://github.com/bluegmlduf2" target="_blank">
                <svg class="h-10 w-10 cursor-pointer" viewBox="0 0 20 20">
            ...
            <a href="https://www.instagram.com/wally_yoon" target="_blank">
                <svg class="h-10 w-10 cursor-pointer" viewBox="0 0 32 32" fill="none">
